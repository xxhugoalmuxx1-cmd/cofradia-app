...
export default function Donations() {
  ...
  async function remove(id: string) {
    if (!window.confirm("¿Seguro que quieres borrar este donativo? No se puede deshacer.")) return;
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {showForm && (
        <form onSubmit={submit} className="bg-white rounded-2xl shadow-sm p-5 space-y-2">
