...
export default function Users() {
  ...
  async function toggleActive(u: any) {
    if (u.isActive && !(await confirm({ title: "Eliminar acceso", message: `¿Eliminar el acceso de ${u.fullName}? Podrás reactivarlo más adelante si hace falta.`, danger: true, confirmLabel: "Eliminar acceso" }))) return;
    try {
  ...
  async function deleteUser(u: any) {
    if (!(await confirm({ title: "Borrar usuario", message: `¿Borrar definitivamente a ${u.fullName}? Esta acción no se puede deshacer.`, danger: true, confirmLabel: "Borrar" }))) return;
    try {
