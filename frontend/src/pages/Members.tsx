...
export default function Members() {
  ...
  return (
    <div className="space-y-6">
      ...
      <input
        placeholder="Buscar por nombre, apellidos, calle o casa…"
        value={search}
                        ...
                        {isHouse && (
                          <div className="bg-gray-50 px-3 py-1.5 flex items-center justify-between">
                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                              🏠 Casa/Portal {houseKey} <span className="font-normal text-gray-400">({houseList.length})</span>
                            </span>
                            <button
      ...
      {showForm && (
        <form onSubmit={submit} className="bg-white rounded-xl shadow-sm p-4 space-y-2 max-w-md">
          ...
          <p className="text-xs text-gray-400 -mt-1">
            Rellena "Nº casa/portal" si conviven varios socios de una misma familia, para agruparlos juntos dentro de la calle.
          </p>
