...
export default function Audit() {
  ...
  async function removeLog(id: string) {
    if (!(await confirm({ title: "Borrar registro", message: "¿Borrar este registro de auditoría? No se puede deshacer.", danger: true, confirmLabel: "Borrar" }))) return;
    try {
  ...
  async function clearOlderThan() {
    ...
    if (!(await confirm({ title: "Limpiar auditoría", message: `Esto borrará todos los registros anteriores al ${clearBefore}. No se puede deshacer.`, danger: true, confirmLabel: "Borrar" }))) return;
    try {
