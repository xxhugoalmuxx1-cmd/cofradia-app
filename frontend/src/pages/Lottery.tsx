...
export default function Lottery() {
  ...
  function saleFormFor(itemId: string): SaleForm {
    return saleForms[itemId] || { unitType: "decimo", unitsSold: "1", amountPaid: "", establishmentName: "" };
  }
  ...
  async function registerSale(item: any, e: React.FormEvent) {
    ...
    // Una sábana equivale a 10 décimos, así que su importe por defecto es 10 veces el precio del décimo.
    ...
    try {
      ...
      setSaleForms((prev) => ({ ...prev, [item.id]: { unitType: "decimo", unitsSold: "1", amountPaid: "", establishmentName: "" } }));
      load();
      if (showHistory) loadHistory();
    } catch (err: any) {
