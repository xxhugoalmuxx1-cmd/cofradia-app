...
// Crear cuentas, editarlas y registrar movimientos es exclusivo del
// administrador — la junta y los usuarios de consulta pueden ver los
// saldos, pero no tocar el banco.
...
router.put("/movements/:id/reconcile", requireAdmin, async (req: AuthedRequest, res, next) => {
  try {
